    ...
    <div class="mt-20 sm:mx-2 lg:mx-10 place-items-center">
      <div class="">
        <div class="text-end mb-5">
          <RouterLink to="/class/create" class="bg-indigo-600 px-3 py-2 rounded-sm text-white text-sm">
            Tambah
          </RouterLink>
        </div>
          ...
          <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            <thead class="text-xs text-gray-700 bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
              <tr>
                ...
                <th class="px-6 py-3 text-center">Jurusan</th>
            ...
            <tbody>
              <tr v-for="item in items" :key="item.id" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                  ...
                  <td class="px-6 py-4 text-center">{{ item.jurusan }}</td>
                  <td class="px-6 py-4 flex justify-center">
                      <RouterLink :to="'/class/' + item.id" class="font-medium bg-blue-500 text-white p-2 rounded mx-1">
